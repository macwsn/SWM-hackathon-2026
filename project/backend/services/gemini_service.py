...
Model used: gemini-1.5-pro (multimodal vision)
"""
...
class GeminiService:
    async def get_indoor_outdoor(self, image_bytes: bytes) -> str:
        ...
        try:
            ...
            logger.error(f"[Gemini] indoor/outdoor failed: {exc}")
            return "outdoor"
    ...
    async def describe_surroundings(
        ...
        try:
            ...
            logger.error(f"[Gemini] describe_surroundings failed: {exc}")
    ...
    async def get_simple_description(self, image_bytes: bytes) -> str:
        ...
        try:
            ...
            logger.error(f"[Gemini] simple_description failed: {exc}")
            return "Brak opisu."
